...
- `components/SettingsView.tsx:65`
- `components/SettingsView.tsx:69`
- `components/LockScreen.tsx:19`
- `components/LockScreen.tsx:21`
...
1. 先做隐私与安全加固：
- 移除前端 API Key 注入。
- 将明文 PIN/安全答案替换为更安全的存储方案，并移除直接展示 PIN 的流程。
